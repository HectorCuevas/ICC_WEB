                            ...
                            <dx:ContentControl runat="server">
                                <dx:ASPxPivotGrid ID="PivotGrid" runat="server" ClientIDMode="AutoID" ClientInstanceName="PivotGrid" DataSourceID="SqlDataSource" Width="100%" OnCustomJsProperties="PivotGrid_CustomJsProperties" OnCustomCallback="PivotGrid_CustomCallback">
                                    <Fields>
                                        ...
                                        <dx:PivotGridField ID="fieldPuntoMonitoreoDSC" Area="ColumnArea" AreaIndex="0" Caption="Punto de Monitoreo" FieldName="PuntoMonitoreo_DSC">
                                        </dx:PivotGridField>
                                        ...
                                        <dx:PivotGridField ID="fieldFechaHoraInicial" FieldName="FechaHoraInicial" Area="RowArea" AreaIndex="0" Caption="Fecha" ValueFormat-FormatString="d" ValueFormat-FormatType="DateTime">
                                        </dx:PivotGridField>
                                    </Fields>
