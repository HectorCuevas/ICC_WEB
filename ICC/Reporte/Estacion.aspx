<%@ Page Title="" Language="C#" MasterPageFile="~/Light.master" AutoEventWireup="true" CodeBehind="Estacion.aspx.cs" Inherits="ICC.Reporte.Estacion" %>
                        ...
                        <ContentCollection>
                            <dx:ContentControl runat="server">                                
                                <dx:ASPxPivotGrid ID="PivotGrid" runat="server" ClientIDMode="AutoID" ClientInstanceName="PivotGrid" DataSourceID="SqlDataSource" Width="100%" 
                                    ...
                                    <Fields>
                                        <dx:PivotGridField ID="fieldEstacion" AreaIndex="0" Caption="Estacion" FieldName="Estacion" Area="ColumnArea">
                                        </dx:PivotGridField>
                                        ...
                                        <dx:PivotGridField ID="fieldFecha" Area="RowArea" AreaIndex="0" Caption="Fecha" FieldName="Fecha">
                                        </dx:PivotGridField>
                                    </Fields>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ICCConnectionString %>" SelectCommand="xSpReporteEstacion" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="dtpFechaInicio" DbType="Date" Name="Fecha" PropertyName="Value" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
                            </dx:ContentControl>
                        </ContentCollection>
...
SubTabs(s,e);	
    ...
    <script type="text/javascript">
        ...
        function FncMarcaInformacion(map, marker, index, oJsonGps_Geografica) {
            try {
                var info = 'Estacion: ' + oJsonGps_Geografica[index].Descripcion;
