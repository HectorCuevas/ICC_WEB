<%@ Page Title="" Language="C#" MasterPageFile="~/Light.master" AutoEventWireup="true" CodeBehind="Derivaciones.aspx.cs" Inherits="ICC.Reporte.Derivaciones" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="panelmaestro">
        <div class="panelopciones">
            <table>
                ...
                <tr>
                    <td>
                        <dx:ASPxComboBox ID="cbxCuenca" runat="server" DataSourceID="SqlDataSourceCuenca" TextField="Cuenca_DSC" ValueField="Cuenca_ID" SelectedIndex="0">
	...
	SubGenerarData();
                ...
                <tr>
                    <td>
                        <dx:ASPxButton ID="btnExcel" runat="server" Text="Exportar Excel" Width="100%" OnClick="btnExcel_Click"></dx:ASPxButton>
                    </td>
                </tr>
            </table>
        </div>
                    ...
                    <dx:TabPage Text="Información">
                        <ContentCollection>
                            <dx:ContentControl runat="server">                                
                                <dx:ASPxPivotGrid ID="PivotGrid" runat="server" ClientIDMode="AutoID" ClientInstanceName="PivotGrid" DataSourceID="SqlDataSource" Width="100%" 
                                    OnCustomJsProperties="PivotGrid_CustomJsProperties" OnCustomCallback="PivotGrid_CustomCallback">
                                    <Fields>
                                        <dx:PivotGridField ID="fieldPuntoMonitoreoDSC" Area="ColumnArea" AreaIndex="1" Caption="Punto de Monitoreo" FieldName="PuntoMonitoreo_DSC" AllowedAreas="ColumnArea">
                                        </dx:PivotGridField>
                                        <dx:PivotGridField ID="fieldCaudal" Area="DataArea" AreaIndex="0" FieldName="Caudal" AllowedAreas="DataArea" CellFormat-FormatString="#.##" CellFormat-FormatType="Custom">
                                        </dx:PivotGridField>
                                        ...
                                        <dx:PivotGridField ID="fieldFechaHoraInicial" FieldName="FechaHoraInicial" Area="RowArea" AreaIndex="0" Caption="Fecha" AllowedAreas="RowArea">
                                        </dx:PivotGridField>
                                        <dx:PivotGridField ID="fieldAnio" AreaIndex="0" Caption="Año" FieldName="Anio" Area="ColumnArea" AllowedAreas="ColumnArea">
                                        </dx:PivotGridField>
                                        <dx:PivotGridField ID="fieldMes" AreaIndex="1" Caption="Mes" FieldName="Mes" Area="RowArea" AllowedAreas="RowArea">
                                        </dx:PivotGridField>
                                        <dx:PivotGridField ID="fieldDia" Area="RowArea" AreaIndex="2" Caption="Dia" FieldName="Dia" AllowedAreas="RowArea">
                                        </dx:PivotGridField>
                                    </Fields>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ICCConnectionString %>" SelectCommand="xSpReporte" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                        ...
                                        <asp:Parameter DefaultValue="2" Name="TipoMedicion_ID" Type="Int32" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
                            </dx:ContentControl>
                        </ContentCollection>
