    ...
    <div class="panelmaestro">
        <div class="panelopciones">
            <table>
                ...
                <tr>
                    <td>
                        <dx:ASPxComboBox ID="cbxCuenca" runat="server" ValueType="System.String" DataSourceID="SqlDataSourceCuenca" TextField="Cuenca_DSC" ValueField="Cuenca_ID" SelectedIndex="0"></dx:ASPxComboBox>
                    </td>
                </tr>
                <tr>
                    <td>
                        ...
                        <ContentCollection>
                            <dx:ContentControl runat="server">                                
                                <dx:ASPxPivotGrid ID="PivotGrid" runat="server" ClientIDMode="AutoID" ClientInstanceName="PivotGrid" DataSourceID="SqlDataSource" Width="100%" OnCustomJsProperties="PivotGrid_CustomJsProperties" OnCustomCallback="PivotGrid_CustomCallback">
                                    <Fields>
                                        <dx:PivotGridField ID="fieldCuencaDSC" AreaIndex="0" Caption="Cuenca" FieldName="Cuenca_DSC">
                                        </dx:PivotGridField>
                                        <dx:PivotGridField ID="fieldSubCuencaRioDSC" AreaIndex="1" Caption="Sub Cuenca" FieldName="SubCuencaRio_DSC">
                                        </dx:PivotGridField>
                                        <dx:PivotGridField ID="fieldPuntoMonitoreoDSC" Area="RowArea" AreaIndex="0" Caption="Punto de Monitoreo" FieldName="PuntoMonitoreo_DSC">
                                        </dx:PivotGridField>
                                        <dx:PivotGridField ID="fieldModeloMolineteDSC" Area="DataArea" AreaIndex="0" Caption="Modelo de Molinete" FieldName="ModeloMolinete_DSC" Visible="False">
                                        </dx:PivotGridField>
                                        ...
                                        <dx:PivotGridField ID="fieldEstadoDSC" Area="DataArea" AreaIndex="0" Caption="Estado Solicitud" FieldName="Estado_DSC" Visible="False">
                                        </dx:PivotGridField>
                                        ...
                                        <dx:PivotGridField ID="fieldFechaHoraInicial" FieldName="FechaHoraInicial" Area="ColumnArea" AreaIndex="0" Caption="Fecha" ValueFormat-FormatString="d" ValueFormat-FormatType="DateTime">
                                        </dx:PivotGridField>
                                    </Fields>
