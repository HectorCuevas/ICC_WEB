<%@ Page Title="" Language="C#" MasterPageFile="~/Light.master" AutoEventWireup="true" CodeBehind="BoletinClimatico.aspx.cs" Inherits="ICC.Catalogo.BoletinClimatico" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="accountHeader">
        <h1>Boletín Climático</h1>
    </div>
    <hr />
    ...
    <asp:SqlDataSource ID="SqlDataBoletin" runat="server" ConnectionString="<%$ ConnectionStrings:ICCConnectionString %>" SelectCommand="xSPBoletines" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:Parameter DefaultValue="1" Name="CodigoOpcion" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
